...
@MicronautTest
class DecisionsCardControllerTest {
    ...
    void save() throws InstantiationException, IllegalAccessException, NoSuchFieldException {
        Randomizer randomizer= new Randomizer<DecisionsCard>(DecisionsCard.class);
    ...
    void findAll() throws InstantiationException, IllegalAccessException, NoSuchFieldException{
        ...
        Iterable<DecisionsCard> list = client.toBlocking().retrieve(request, Iterable.class);
        assertNotNull(list);
