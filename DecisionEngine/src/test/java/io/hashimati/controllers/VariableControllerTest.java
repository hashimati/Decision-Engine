...
class VariableControllerTest {
    ...
    void save() throws InstantiationException, IllegalAccessException, NoSuchFieldException {
        Randomizer randomizer= new Randomizer<Variable>(Variable.class);
    ...
    void findAll() throws InstantiationException, IllegalAccessException, NoSuchFieldException{
        ...
        Iterable<Variable> list = client.toBlocking().retrieve(request, Iterable.class);
        assertNotNull(list);
